...
function withRollingMicrostructureSnapshot(market, rollingMicrostructureSnapshot, nowMs = Date.now()) {
  ...
  return {
    ...
    absorptionScore: row.absorptionScore ?? market.absorptionScore,
    aggressiveSellsFailed: row.aggressiveSellsFailed ?? market.aggressiveSellsFailed,
    deltaImprovementPct: row.deltaImprovementPct ?? market.deltaImprovementPct,
